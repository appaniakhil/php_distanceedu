...
<html>
<head>
<title>&nbsp;&nbsp;&nbsp;&nbsp; Online Admission form for distance education , various courses </title>
</head>
...
<td class="tablecontent1">&nbsp;&nbsp;&nbsp;&nbsp Gender<span class="alert"><font color=red>*</font></span></td>
 ...
 <tr><td class="tablecontent2">&nbsp;&nbsp;&nbsp;&nbsp course<span class="alert"><font color=red>*</font></span></td>
<break>
	<td class="tablecontent2">
...
<input type="hidden" name="modtype" id="modtype" value="1"/>
  ...
  <p>
<input   type="submit" value="Submit" href="edu.php" name="submit" />  
<a href="profile.php">bak to profile</a>
  </center></div>
</form>
</body>
</html>
...
{  
  ...
  $fname ==""  ||$religion ==""  ||$address ==""  || $state ==""  ||$course =="" || $pincode ==""  ||  $email ==""  ||$mobile ==""  )
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				(sal,fullname,age,Mstatus,gender,opt_cat,mname,fname,religion,address,course,state,pincode,email,mobile) 
				values
				('$sal','$fullname','$age','$Mstatus','$gender','$opt_cat','$mname','$fname','$religion','$address','$state','$course','$pincode','$email','$mobile')",$conn)
